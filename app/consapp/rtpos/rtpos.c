...
#define PRGNAME     "rtpos"            /* program name */
#define CMDPROMPT   "rtpos> "          /* command prompt */
...
#define OPTSFILE    "rtpos.conf"       /* default config file */
#define NAVIFILE    "rtpos.nav"        /* navigation save file */
#define STATFILE    "rtpos_%Y%m%d%h%M.stat"  /* solution status file */
#define TRACEFILE   "rtpos_%Y%m%d%h%M.trace" /* debug trace file */
#define LOGFILE     "rtpos_%Y%m%d%h%M.log"   /* Deamon log file */
...
static int soltype      =1;             /* sol format (0:dms,1:deg,2:xyz,3:enu,4:pyl) */
static int solflag      =3;             /* sol flag (1:std+2:age/ratio/ns) */
